...
<body><br><br>
    <center><h1>Fusion 3.0</h1></center><br>
    <center>
      <p style="width: 70vw; max-width: 100%;">

      O Ford Fusion 3.0 é uma combinação notável de sofisticação, desempenho e tecnologia. Este sedan de porte médio se destaca pelo seu design elegante e linhas aerodinâmicas, criando uma presença marcante nas estradas. <br><br>

      Sob o capô, o Fusion 3.0 oferece um desempenho potente e eficiente. Equipado com um motor V6 de 3.0 litros, este carro proporciona uma experiência de condução emocionante, com uma mistura de potência e eficiência de combustível. A tecnologia avançada de transmissão e suspensão contribui para uma    condução suave e responsiva.

      </p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="./carros/Fusion01.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/Fusion02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/Fusion03.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/Fusion04.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/Fusion05.jpg">
    </div>
