...
<img src="CarrosWeb.PNG" style="width: 100vw" alt="">

<header class="cabeçalho">
    <nav class="container1">
    <li class="cabeçalho__lista">
      <a class="cabeçalho__link" href="file:///C:/wamp64/www/CarrosWeb/index.php">Início</a>
      <a class="cabeçalho__link" href="http://localhost/CarrosWeb/ShowRoom.php">ShowRoom</a>
  ...
  <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z"/>
      ...
      <a class="cabeçalho__link" href="https://www.google.com.br/">Sair</a>
    </nav>  
    </li>
  </header>
  <body>
  <center><h1>Bem-Vindo, ao seu site de venda e troca de veículos!</h1></center><br>
  <center><p>Compre, Venda, Avalie, Compare e saiba todas as notícias do mercado automotivo, na loja líder do segmento. Tudo sobre carros novos, usados e seminovos.</p></center><br><br>
  <div class="slideshow-container">
    <div class="mySlides fade">
      <div class="numbertext">1 / 6</div>
      <img src="./images/BMW.jpg" style="width:100%; border-radius: 50px;">
    </div>
    
    <div class="mySlides fade">
      <img src="./images/DucatiSunset.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./images/F1.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./images/HeavyBike.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./images/Fusca.jpg">
    </div>
    <div class="mySlides fade">
