...
<body><br><br>
    <center><h1>Land Rover</h1></center><br>
    <center><p style="width: 70vw; max-width: 100%;">A Land Rover é uma marca britânica conhecida por produzir veículos utilitários esportivos (SUVs) e veículos todo-terreno de luxo. Um dos modelos mais emblemáticos da Land Rover é o Range Rover. Aqui está uma descrição geral para um veículo da Land Rover: <br><br>

A Land Rover é sinônimo de aventura e luxo no universo dos veículos off-road. Com uma herança que remonta a meados do século XX, os veículos Land Rover são reconhecidos por sua capacidade todo-terreno excepcional, combinada com o conforto e a elegância típicos de um SUV de luxo.</p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="./carros/land01.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/land02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/land03.jpg">
    </div>
