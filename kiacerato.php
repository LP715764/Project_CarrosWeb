...
<body><br><br>
    <center><h1>Kia Cerato</h1></center><br>
    <center><p style="width: 70vw; max-width: 100%;">O Kia Cerato é um sedã compacto que combina elegância, eficiência e tecnologia em um pacote atraente. Com linhas modernas e um design aerodinâmico, o Cerato destaca-se pela sua presença sofisticada nas estradas urbanas. <br><br>

Sob o capô, o Kia Cerato oferece desempenho equilibrado e eficiência energética. Seja explorando a cidade ou embarcando em viagens mais longas, o motor responsivo proporciona uma condução suave e eficaz. Além disso, a atenção aos detalhes na suspensão e na direção contribui para uma experiência de condução confortável.</p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="Carros/CERATO01.jpg">
    </div>
    <div class="mySlides fade">
      <img src="Carros/CERATO02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="Carros/CERATO03.jpg">
    </div>
    <div class="mySlides fade">
      <img src="Carros/CERATO04.jpg">
    </div>
    <div class="mySlides fade">
      <img src="Carros/CERATO05.jpg">
    </div>
