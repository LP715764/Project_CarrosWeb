...
<title>Carros Web - Chevrolet Camaro SS </title>
...
<header class="cabeçalho" style="padding: 3rem 0">
    ...
    <a class="cabeçalho__link" href="http://localhost/CarrosWeb/index.php">Início</a>
      ...
      <a class="cabeçalho__link" href="ShowRoom.php">ShowRoom</a>
      ...
      <a class="cabeçalho__link" href="http://localhost/LojaCarros/Login.php"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
...
<body><br><br>
    <center><h1>Dodge Challenger</h1></center><br>
    <center><p style="width: 70vw; max-width: 100%;">O Dodge Challenger é um icônico carro esportivo americano que personifica a potência e o estilo. Com um design musculoso e linhas agressivas, o Challenger é conhecido por sua presença imponente nas estradas. Sob o capô, este veículo oferece uma gama de opções de motorização, desde poderosos V6 até os robustos V8, proporcionando uma experiência de condução emocionante.<br><br>No interior, o Dodge Challenger combina conforto e tecnologia. Os assentos esportivos envolventes, os detalhes de acabamento de alta qualidade e os recursos modernos criam um ambiente envolvente para motoristas e passageiros. Além disso, a conectividade avançada e os sistemas de entretenimento garantem uma experiência de viagem agradável.<br><br>Com uma herança que remonta aos lendários muscle cars da década de 1970, o Dodge Challenger mantém a tradição de desempenho e estilo. Seja para um cruzeiro descontraído pela cidade ou para dominar a pista, o Challenger é um carro que impressiona pela sua presença e desempenho excepcionais.</p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="./carros/dodge01.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/dodge02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/dodge03.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/dodge04.jpeg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/dodge05.jpeg">
    </div>
...
<a class="next" onclick="plusSlides(1)">&#10095;</a>
  ...
  <div style="text-align:center">
    ...
    <br><br>
           ...
           <div align="justify" class="container"><font size=3 style="color:#fff; font-family: 'Montserrat', sans-serif; font-weight: bold;  text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;" align="justify"></font></div>	
  <br><br><br><br>
           </div>
  ...
  <center>
              ...
              <a href="http://localhost/CarrosWeb/cliente.php">
              <div class="botaoItem">
