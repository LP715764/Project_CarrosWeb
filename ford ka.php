...
<body><br><br>
    <center><h1>Ford Ka</h1></center><br>
    <center><p style="width: 70vw; max-width: 100%;">O Ford Ka é um carro compacto que se destaca pela sua praticidade e eficiência. Com um design moderno e dimensões compactas, o Ka é ideal para a condução urbana, tornando-se uma escolha popular para aqueles que buscam um veículo ágil e econômico. <br><br>

Sob o capô, o Ford Ka oferece opções de motores eficientes que proporcionam um equilíbrio entre desempenho e economia de combustível. Sua dirigibilidade ágil e fácil estacionamento tornam-no uma escolha conveniente para a vida na cidade, enquanto a tecnologia embarcada oferece recursos modernos para uma experiência de condução conectada.</p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="./carros/KA05.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/KA04.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/KA03.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/KA02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/KA01.jpg">
    </div>
