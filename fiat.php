...
<body><br><br>
    <center><h1>Fiat Siena</h1></center><br>
    <center><p style="width: 70vw; max-width: 100%;">O Fiat Siena é um carro que se destaca por oferecer uma opção de sedan compacto acessível e eficiente. Com linhas simples e um design funcional, o Siena é projetado para atender às necessidades práticas de mobilidade urbana. <br><br>

Exteriormente, o Fiat Siena apresenta um perfil elegante e proporcional, com destaque para a grade frontal distintiva e faróis bem integrados. Sua abordagem de design enfatiza a praticidade, tornando-o um veículo fácil de manobrar em ambientes urbanos.</p></center><br><br>
    <div class="slideshow-container">
    
    <div class="mySlides fade">
      <img src="./carros/fiat01.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/fiat02.jpg">
    </div>
    <div class="mySlides fade">
      <img src="./carros/fiat03.jpg">
    </div>
